...
<HTML>
<HEAD>
<TITLE>Vishal Car Rental Company</TITLE>
</HEAD>
<BODY>
<?php
	...
	{
		$errosOnPage[] = "Your return date and time should be later than your pickup time for car renting.";
	}
	...
	{
		$errosOnPage[] = "Please enter only Pickup Airport Location or Pick up Address but not both.";
	}
	...
	if($pickup_location_code == NULL)
	{
		...
		{
			$errosOnPage[] = "you forget to enter street for car renting";
		}
		...
		{
			$errosOnPage[] = "you forget to enter pickup city for car renting";
		}
		...
		{
			$errosOnPage[] = "you forget to enter pickup state for car renting";
		}
		...
		{
			$errosOnPage[] = "you forget to enter pickup country for car renting.";
		}
	}
	else
	{
	...
	{
		$errosOnPage[] = "Please provide Flight Number and Airline code if any one of the information is filled.";
	}
	...
	if($rental_oneway != NULL)
	{
		...
		{
			$errosOnPage[] = "Please enter only Return Airport Location or Return Address but not both.";
		}
		...
		if($return_location_code == NULL)
		{
			...
			{
				$errosOnPage[] = "you forget to enter returning car street for car renting";
			}
			...
			{
				$errosOnPage[] = "you forget to enter returning car  city for car renting.";
			}
			...
			{
				$errosOnPage[] = "you forget to enter returning car  state for car renting.";
			}
			...
			{
				$errosOnPage[] = "you forget to enter returning car  country for car renting.";
			}
		}
		else
		{
	...
	{
			$errosOnPage[] = "Please enter both infant seats and its Quantity Information and not just one.";
	}
	if(($child_infant_seat != NULL) && ($child_infant_seat_quantity != NULL))
	{
	...
	{
			$errosOnPage[] = "Please enter both child safty seats and its Quantity Information and not just one.";
	}
	...
	{
			$errosOnPage[] = "Please enter both booster seats and its Quantity Information and not just one.";
	}
	if(($child_booster_seat != NULL) && ($child_booster_seat_quantity != NULL))
	{
	...
	{
			$errosOnPage[] = "You forget to select car type for car renting.";
	}
	...
	{
		$errosOnPage[] = "you forget to enter your first name for car renting.";
	}
	...
	{
		$errosOnPage[] = "you forget to enter your last name for car renting.";
	}
	...
	{
		$errosOnPage[] = "you forget to enter your email address for car renting";
	}


	//Display the information which user entered on the form. First display the errors and then the information entered.
	echo "<b>Please verify the information below and if there is any errors then please go back and correct them first for faster and accurate service. <br/>Thank you for doing business with vishal car renting.</b><br/><br/>";

	$count = 0;
	echo "<p><font color=\"red\">";
	foreach($errosOnPage as $value)
	{
		if($count == 0)
			echo "<b>Here is the List of the Errors on the information submitted:</b><br/><br/>";
		$count = $count + 1;
		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $value <br/>";
	}
	"</font></p>";

	echo "<p><font color=\"black\"><b>Here is all the information submitted you submitted for Renting the Car:</b><br/><br/>";
	foreach($successfulValueOnPage as $value)
	{
		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $value <br/>";
	}
	"</font></p>";
